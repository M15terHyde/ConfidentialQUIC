...
from aioquic.asyncio.conf_client import connect
from aioquic.asyncio.conf_protocol import QuicConnectionProtocol
...
if __name__ == "__main__":
    ...
    loop.run_until_complete(
        run(
            ...
            send_as_ipv6='2001:4860:4860::8811',
            send_as_port=9999,
            recv_from_ipv6='2001:4860:4860::8810',
            recv_from_port=9999,
        )
    )