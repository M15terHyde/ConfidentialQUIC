...
sleep 2 ;
python examples/conf_test4/http3_client.py -v -q /qlogstore --ca-certs tests/pycacert.pem https://[2001:db8:1::10]:4433/

sleep 1 ;
python examples/conf_test4/http3_client.py -v -q /qlogstore --ca-certs tests/pycacert.pem https://[2001:db8:1::10]:4433/1234